...
**Shipped version:** 5.17.0~ynh1 *(:warning: This is the `ci-auto-update-v5.17.0` branch. The [`master` branch](https://github.com/YunoHost-Apps/ghost_ynh/tree/master) used in the catalog is currently on version 5.16.2\~ynh1.)*
